    ...
    <section className="relative overflow-hidden border-y border-[var(--border)] bg-gradient-to-b from-surface to-bg px-6 py-24 text-center">
      ...
      <Reveal className="relative z-10 mx-auto max-w-2xl">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3.5">
          <Link
            href="/contact"
            className="rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-[#06110E] transition-transform hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-6px_var(--accent-glow)]"
          >
            {primaryLabel}
          </Link>
          <a
            ...
            target="_blank"
            rel="noopener"
            className="rounded-full border border-[var(--border)] px-7 py-3.5 text-sm font-semibold transition-colors hover:border-accent hover:text-accent"
          >
            WhatsApp Us
          </a>
        </div>
